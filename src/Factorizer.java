...
public class Factorizer implements AM{
    public void run(AMInfo info)
    {
        ...
        System.out.print("class Factorizer method run read data from parent server\nn = " + ln + "\nl = " +
                ll + "\nr = " + lr + "\n\n");
        ...
        if(res != null)
        {
            System.out.print("class Factorizer method run result p = " + res + "\n");

            info.parent.write(res.longValue());
        }
        else
        {
            System.out.print("class Factorizer method run find no solution\n");
